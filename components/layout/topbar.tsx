    ...
    >
      ...
      <nav className="hidden sm:flex items-center gap-1 min-w-0 flex-shrink">
        {breadcrumbs.length > 0 ? (
              ...
              return (
                <li key={index} className="flex items-center gap-1">
                  ...
                  {crumb.href && !isLast ? (
                    <Link
                      href={crumb.href}
                      className="text-sm text-slate-500 hover:text-[#1E3A5F] transition-colors truncate max-w-[120px]"
                    >
                      {crumb.label}
                    </Link>
                  ) : (
          ...
          <span className="text-sm font-semibold text-slate-900">Illume Student Advisory Services</span>
        )}
      </nav>
      ...
      >
        <div className="relative">
          ...
          <Input
            ...
            className="pl-9 h-9 bg-slate-50 border-slate-200 focus-visible:ring-[#1E3A5F] placeholder:text-slate-400 w-full"
          />
        </div>
      </form>
      ...
      <div className="flex items-center gap-2 shrink-0">
        {/* Notification Bell */}
        <button
          className="relative flex items-center justify-center h-9 w-9 rounded-lg text-slate-500 hover:text-slate-900 hover:bg-slate-100 transition-colors"
