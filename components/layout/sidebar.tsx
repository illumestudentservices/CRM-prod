  ...
  return (
    <TooltipProvider delayDuration={0}>
      ...
      >
        ...
        >
          <div className="flex items-center justify-center w-8 h-8 rounded-lg bg-[#0EA5E9] shrink-0">
        ...
        <div className="px-2 py-2 border-t border-[#2a4a73]">
          <button
            ...
            className={cn(
              "flex items-center justify-center h-8 w-full rounded-lg text-slate-400 hover:text-white hover:bg-white/10 transition-all duration-150",
        ...
        {/* User Footer */}
        <div className={cn("p-3 border-t border-[#2a4a73] shrink-0")}>
          {collapsed ? (
            <Tooltip>
              <TooltipTrigger asChild>
