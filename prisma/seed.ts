...
async function main() {
  ...
  const sources = await Promise.all([
    db.recruitmentPartner.upsert({ where: { id: "src-001" }, update: {}, create: { id: "src-001", name: "EduBridge Malaysia", type: SourceType.AGENT, country: "Malaysia", city: "Kuala Lumpur", contactPerson: "Ahmad Razali", email: "ahmad@edubridge.my", phone: "+60-12-9876543", rating: 5, agreementStatus: "Signed", regionId: regionSEA.id, createdById: adminUser.id, lastActiveAt: new Date() } }),
    db.recruitmentPartner.upsert({ where: { id: "src-002" }, update: {}, create: { id: "src-002", name: "Global Path India", type: SourceType.AGENT, country: "India", city: "Mumbai", contactPerson: "Ravi Patel", email: "ravi@globalpath.in", phone: "+91-98765-12345", rating: 4, agreementStatus: "Signed", regionId: regionSA.id, createdById: adminUser.id, lastActiveAt: new Date() } }),
    db.recruitmentPartner.upsert({ where: { id: "src-003" }, update: {}, create: { id: "src-003", name: "StudyAbroad UAE", type: SourceType.AGENT, country: "UAE", city: "Dubai", contactPerson: "Khalid Al-Mansouri", email: "khalid@studyabroad.ae", rating: 4, agreementStatus: "Signed", regionId: regionME.id, createdById: adminUser.id, lastActiveAt: new Date() } }),
    db.recruitmentPartner.upsert({ where: { id: "src-004" }, update: {}, create: { id: "src-004", name: "Future Scholars Nigeria", type: SourceType.AGENT, country: "Nigeria", city: "Lagos", contactPerson: "Chukwuemeka Obi", email: "chuks@futurescholars.ng", rating: 3, agreementStatus: "Pending", regionId: regionAFR.id, createdById: adminUser.id, lastActiveAt: new Date() } }),
    db.recruitmentPartner.upsert({ where: { id: "src-005" }, update: {}, create: { id: "src-005", name: "INTI International College", type: SourceType.SCHOOL, country: "Malaysia", city: "Kuala Lumpur", contactPerson: "Dr. Mei Ling", email: "partnerships@inti.edu.my", rating: 5, agreementStatus: "Signed", regionId: regionSEA.id, createdById: adminUser.id, lastActiveAt: new Date() } }),
    db.recruitmentPartner.upsert({ where: { id: "src-006" }, update: {}, create: { id: "src-006", name: "Delhi Public School Network", type: SourceType.SCHOOL, country: "India", city: "New Delhi", contactPerson: "Principal Sharma", email: "intl@dps.edu.in", rating: 4, agreementStatus: "Signed", regionId: regionSA.id, createdById: adminUser.id, lastActiveAt: new Date() } }),
    db.recruitmentPartner.upsert({ where: { id: "src-007" }, update: {}, create: { id: "src-007", name: "GEMS Education Dubai", type: SourceType.SCHOOL, country: "UAE", city: "Dubai", contactPerson: "Maria Fernandez", email: "counsellor@gems.ae", rating: 5, agreementStatus: "Signed", regionId: regionME.id, createdById: adminUser.id, lastActiveAt: new Date() } }),
    db.recruitmentPartner.upsert({ where: { id: "src-008" }, update: {}, create: { id: "src-008", name: "Campus Walk-in KL", type: SourceType.WALK_IN, country: "Malaysia", city: "Kuala Lumpur", rating: 3, regionId: regionSEA.id, createdById: adminUser.id } }),
    db.recruitmentPartner.upsert({ where: { id: "src-009" }, update: {}, create: { id: "src-009", name: "Google Ads – UK Programs", type: SourceType.DIGITAL, country: "Malaysia", rating: 3, regionId: regionSEA.id, createdById: adminUser.id } }),
    db.recruitmentPartner.upsert({ where: { id: "src-010" }, update: {}, create: { id: "src-010", name: "Meta/Instagram Campaign", type: SourceType.CAMPAIGN, country: "India", rating: 3, regionId: regionSA.id, createdById: adminUser.id } }),
    db.recruitmentPartner.upsert({ where: { id: "src-011" }, update: {}, create: { id: "src-011", name: "Arab Education Partners", type: SourceType.PARTNER, country: "Saudi Arabia", city: "Riyadh", contactPerson: "Abdullah Al-Saud", email: "aep@arabedpartners.com", rating: 4, agreementStatus: "Signed", regionId: regionME.id, createdById: adminUser.id, lastActiveAt: new Date() } }),
    db.recruitmentPartner.upsert({ where: { id: "src-012" }, update: {}, create: { id: "src-012", name: "Kenya Education Consultants", type: SourceType.AGENT, country: "Kenya", city: "Nairobi", contactPerson: "Wanjiku Kamau", email: "wanjiku@kenedu.co.ke", rating: 3, agreementStatus: "Pending", regionId: regionAFR.id, createdById: adminUser.id } }),
    db.recruitmentPartner.upsert({ where: { id: "src-013" }, update: {}, create: { id: "src-013", name: "Vietnam Study Abroad", type: SourceType.AGENT, country: "Vietnam", city: "Ho Chi Minh City", contactPerson: "Nguyen Thi Lan", email: "lan@studyabroad.vn", rating: 4, agreementStatus: "Signed", regionId: regionSEA.id, createdById: adminUser.id, lastActiveAt: new Date() } }),
    db.recruitmentPartner.upsert({ where: { id: "src-014" }, update: {}, create: { id: "src-014", name: "Indonesia Global Education", type: SourceType.AGENT, country: "Indonesia", city: "Jakarta", contactPerson: "Budi Santoso", email: "budi@indoedu.co.id", rating: 4, agreementStatus: "Signed", regionId: regionSEA.id, createdById: adminUser.id, lastActiveAt: new Date() } }),
    db.recruitmentPartner.upsert({ where: { id: "src-015" }, update: {}, create: { id: "src-015", name: "YouTube Study Abroad Channel", type: SourceType.DIGITAL, country: "Global", rating: 2, regionId: regionSEA.id, createdById: adminUser.id } }),
  ]);
  ...
  const leadData = [
    ...
    { fullName: "Siti Nurhaliza Binti Ahmad", email: "siti.n@gmail.com", phone: "+60-13-4567890", nationality: "Malaysian", countryOfResidence: "Malaysia", interestedProgram: "BSc Pharmacy", faculty: "Medicine & Life Sciences", studyLevel: StudyLevel.UNDERGRADUATE, intakeYear: 2026, intakeMonth: 1, stage: LeadStage.NEW_LEAD, sourceId: srcEduBridge.id, institutionId: instUOM.id, assignedICRId: icrUser.id, regionId: regionSEA.id },
