...
export default async function LeadDetailPage({
  ...
  const gates = gateLead
    ? ALL_STAGES.filter(
        ...
        // `hasInstitutionInterest` and `eligibilityOutcome` are derived inside
        // loadLeadForGate — they are not columns, and deriving them at each
        // call site is what left this panel reporting blockers that were
        // already satisfied.
